...
close all
ctdType = 'seahawk';
rootDIR = '/Users/derekgrimes/OneDriveUNCW/Documents-UNCW-BOEM-FryingPanShoals/General/data';
for ii=1:7
    depDir = sprintf([rootDIR,filesep,'BOEM_deployment%d',filesep],ii);
    rawDir  = [depDir, filesep, 'RVSH_flowthrough',filesep];
