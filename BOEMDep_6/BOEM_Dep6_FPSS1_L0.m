...
basepath = '~/OneDrive - UNC-Wilmington/Documents/Research/BOEM_OneDrive/General/data/BOEM_deployment6';
% Exported file names for each instrument to process:
fname_rbrd1 = '207222_20250305_1400.rsk';
fname_rbrt = '214016_20250305_2301.rsk';
fname_sbe = '1311_030525.asc';

% Start time and end time, rounded to nearsest hour that instrument is stable.
% In GMT - look at the deploy/recover logs.
% NOTE: This lander was trawled up and brought to Jacksonville, FL.
start_time = '02/04/2025 21:00:00';
end_time = '02/07/2025 01:00:00';
...
[SBE37L0,fname_sbe_new]=SBE37_load_nopressure(fname_sbe_full,save_to_path,depnum,StationID,stime,etime);%Does not work 
...
% Currents
inpathc = strcat(basepath,'/',StationID,'/RAW/WAVES/WAVES_000_000_TS2502041400_CUR.PD0');
