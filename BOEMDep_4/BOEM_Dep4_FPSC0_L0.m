...
fname_rbrd1 = '207221_20240922_1904.rsk';
fname_rbrd2 = '210870_20240922_1856.rsk';
fname_rbrt = '214015_20241127_1649.rsk';

fname_sbe = 'BOEM4_26944_C0.asc';
...
start_time = '08/20/2024 16:00:00';
end_time = '09/19/2024 16:00:00';
...
% Currents
inpathc = strcat(basepath,'/',StationID,'/RDI/WAVES/WAVES_000_000_TS2408201100_CUR.PD0');
[currents] = RDIWH_load_currents(inpathc,save_to_path,depnum,StationID,ADCPparams,stime,etime);
% Waves path to directory
inpathw = strcat(basepath,'/',StationID,'/RDI/WAVES/SPEC/');
...
aa = find(turbidity>=800); 
turbf = turbidity;turbf(aa) = NaN;qcFlag.turbidty = ones(length(time),1);qcFlag.turbidty(aa) = 0;
%Rename:
FDOM = fdomf;turbidity = turbf;
chlorophyll_a = chlf;
% Remove the times that the instrument was buried:
bb = find(time>=datenum(2024,9,16));
FDOM(bb) = NaN;turbidity(bb) = NaN;
chlorophyll_a(bb) = NaN;
notesqc = {'Removed spikes in FDOM and TURB and Chlf. The last 3 days are NaN because of burial';
