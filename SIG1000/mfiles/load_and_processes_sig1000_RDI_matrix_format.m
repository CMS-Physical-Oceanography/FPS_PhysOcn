...
outFile = [outRoot, L0FRoot, 'config.mat'];
...
% $$$     out.CorBeam5   (N+1:N+(ie-(is-1)),1:Nc)  = Data.IBurst_Correlation_Beam(is:ie,1,1:Nc);
    out.Velocity_East    (1:Nc,N+1:N+(ie-(is-1)))  = Data.Burst_Velocity_ENU(is:ie,1,1:Nc);
    out.Velocity_North   (1:Nc,N+1:N+(ie-(is-1)))  = Data.Burst_Velocity_ENU(is:ie,2,1:Nc);
    out.Velocity_Up      (1:Nc,N+1:N+(ie-(is-1)))  = Data.Burst_Velocity_ENU(is:ie,3,1:Nc);
    out.Velocity_Error   (1:Nc,N+1:N+(ie-(is-1)))  = Data.Burst_Velocity_ENU(is:ie,4,1:Nc);
...
% $$$         out.beam2xyz = beam2xyz;
        ...
        % save output
        outNf = outNf+1;
        outFileName = sprintf([L0FRoot,'%03d.mat'],outNf);
