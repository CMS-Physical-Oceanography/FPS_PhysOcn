...
while ii<=Nf
    ...
    out.VelBeam1   (N+1:N+(ie-(is-1)),1:Nc)  = Data.Burst_Velocity_Beam(is:ie,1,1:Nc);
    ...
    out.Echo1      (N+1:N+(ie-(is-1)),1:NcE) = Data.Echo1Bin1_1000kHz_Echo(is:ie,1:NcE);
    out.Echo2      (N+1:N+(ie-(is-1)),1:NcE) = Data.Echo2Bin1_1000kHz_Echo(is:ie,1:NcE);    
    %
    N = N+ie-(is-1);
    is= ie+1;
    %
